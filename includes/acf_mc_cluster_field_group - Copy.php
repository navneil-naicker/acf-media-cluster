...
<!--div class="acf-mc-field-group acf-mc-field-group-row acf-mc-field-group-<?php echo $group; ?>">
	<div class="acf-mc-field-column acf-mc-field-column-filename">
		<input class="acf-mc-field-filename" type="text" readonly name="filename" value="<?php echo basename($url); ?>"/>
		<a href="<?php echo esc_url($url); ?>" target="_blank" title="View media" class="button acf-mc-field-file-viewer"><span class="dashicons dashicons-welcome-view-site"></span></a>
	</div>
	...
	<div class="acf-mc-field-column acf-mc-field-column-action">
		...
		<?php } ?>
		<a href="#" title="Choose File from Media Library" class="button button-choose-file button-primary" data-key="<?php echo preg_replace('/[^a-z0-9_]/', '', $key); ?>" data-name="<?php echo preg_replace('/[^a-z0-9_]/', '', $fname); ?>" data-group="acf-mc-field-group-<?php echo preg_replace("/[^0-9]/", "",$group); ?>"><span class="dashicons dashicons-cloud-upload"></span></a>
...
<div class="flex-container">
	<div>
		<input class="acf-mc-field-filename1" type="text" readonly name="filename" value="<?php echo basename($url); ?>"/>
	</div>
	<div><input class="acf-mc-field-title" type="text" readonly name="title" value="<?php echo sanitize_text_field($title); ?>"/></div>
	<div>ab2</div>
</div>
<?php
